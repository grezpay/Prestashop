...
<div class="loader">
    <img src="https://www.grezpay.com/img/logo.png" class="centre-image">
</div>  
...
class GrezPayValidationModuleFrontController extends ModuleFrontController
{
    public $ssl = true;
    ...
    public function postProcess()
    {
        ...
        //$merchant_website=$merchant_website."en/module/grezpay/validation";
        $merchant_website=$merchant_website."en/module/grezpay/thankyou";
        //test for redirect
       ...
       // @$pg_transaction->setCustShipName($_REQUEST['CUST_SHIP_NAME']);
        ...
        $this->setTemplate('module:grezpay/views/templates/front/payment_return.tpl');
