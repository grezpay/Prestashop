...
class GrezPay extends PaymentModule
{
    protected $_html = '';
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('Grezpay Payment Gateway');
        $this->description = $this->l('If you are looking for a reliable online payment partner, head towards GrezPay, we offer 100+ Payment options. Easy to integrate with your website with tons of ready-to-go plugins for major open source ecommerce.');
    ...
    public function displayForm()
{
    ...
    public function getExternalPaymentOption()
    {
        ...
        $externalOption->setCallToActionText($this->l('Pay By GrezPay'))
    ...
    protected function generateForm()
    {
        ...
        return $this->context->smarty->fetch('module:grezpay/views/templates/front/payment_form.tpl');
    }
}
